...
" Bundles {
    ...
    if dein#load_state('~/.cache/dein')
        ...
        call dein#add('maxmellon/vim-jsx-pretty')           " Better JSX syntax
        call dein#add('yuezk/vim-js')                       " Modern JS syntax
        call dein#add('HerringtonDarkholme/yats.vim')       " Better TypeScript
        call dein#add('styled-components/vim-styled-components') " styled-components

        " Development tools
        call dein#add('prettier/vim-prettier')              " Code formatting
        call dein#add('mattn/emmet-vim')                   " HTML/JSX expansion
        call dein#add('alvan/vim-closetag')                " Auto-close JSX tags
        ...
        call dein#add('phpactor/phpactor')                 " PHP language server
        call dein#add('noahfrederick/vim-composer')        " Composer integration
        call dein#add('adoy/vim-php-refactoring-toolbox')  " PHP refactoring
        call dein#add('tobyS/pdv')                         " PHP documentor
        call dein#add('beyondwords/vim-twig')

        " Perl development
        call dein#add('vim-perl/vim-perl')                 " Modern Perl syntax
        call dein#add('c9s/perlomni.vim')                  " Perl completion
...
" PHP settings (adjust to your team's standards)
...
" React/JS specific mappings
autocmd FileType javascript,javascriptreact,typescript,typescriptreact nnoremap <buffer> <leader>r :!npm test<CR>
autocmd FileType javascript,javascriptreact,typescript,typescriptreact nnoremap <buffer> <leader>b :!npm run build<CR>

" PHP specific mappings
autocmd FileType php nnoremap <buffer> <leader>r :!php %<CR>
autocmd FileType php nnoremap <buffer> <leader>t :!./vendor/bin/phpunit<CR>

" Perl specific mappings
autocmd FileType perl nnoremap <buffer> <leader>r :!perl %<CR>
autocmd FileType perl nnoremap <buffer> <leader>c :!perl -c %<CR>
...
nnoremap <leader>comp :Files src/components<CR>
nnoremap <leader>hook :Files src/hooks<CR>

" Find PHP classes/files
nnoremap <leader>php :Files app/<CR>
nnoremap <leader>mod :Files app/Models<CR>

" Search in project files
nnoremap <leader>rg :Rg<space>
nnoremap <leader>rw :Rg <C-r><C-w><CR>  " Search word under cursor
